...
output_gbif_cubes_base_dir <- "inst/extdata/gbif_data_cubes_mgrs" # Changed directory for MGRS cubes
...
cube_measurement_type <- "OCCURRENCE_COUNT" # <--- IMPORTANT: CHOOSE YOUR DESIRED CUBE TYPE
...
test_bbox_wkt_filepath <- "inst/extdata/ramsar_sites_wkt/Switzerland/site_1_Le Rh_ne genevoi_ _ Vallon_ de l_Allondon et de la Laire_bbox.wkt" # <--- REPLACE WITH A REAL PATH
