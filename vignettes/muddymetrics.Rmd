...
Continental GBIF occurrence cubes (100 m MGRS grid) are downloaded from the GBIF web interface and split into per-site cubes with `scripts/split_data_cubes_targeted.R` and `scripts/split_data_cubes_remaining.R`.
